...
//////////////// QUESTION 4 ////////////////
////////////////////////////////////////////
/* (appendLL) Write a C function that takes
 * two lists, ‘a’ and ‘b’, appends ‘b’ onto
 * the end of ‘a’, and then sets ‘b’ to
 * NULL (since it is now trailing off the end of ‘a’).
 */
/*
 //////////////////////////////////////////////////////////////////////////////////
...
/////////////////// TODO ///////////////////
////////////////////////////////////////////
    ListNode* curB = ll_b->head;
    int sizeA = ll_a->size;
    while (curB != NULL)
    {
        insertNode(ll_a, sizeA++, curB->item);
