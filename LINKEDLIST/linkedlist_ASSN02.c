...
//////////// TODO ////////////
//////////////////////////////
// insert nodes in ll2 into alternate positions of ll1
//1 5 7 3 9 11
//6 10 2 4
//insert at index 1
//1 6 5 7 3 9 11
...
//2 4
    ...
    int index1 = 1;
    int numToInsert = ll1->size;
    while (numToInsert--)
    {
        if(ll2->head != NULL) // if there are no more nodes in ll2, don't do anything else will SIGSEGV
        {
