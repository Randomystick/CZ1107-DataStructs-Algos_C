...
//////////////////////////////
    ...
    int indexxBack  = 0;
    int indexxFront = 0;
    int sizeeFront  = sizee-sizee/2; //integer division in C will always drop the decimal, no matter how big (4.99 == 4.5 == 4)
    ...
    while (ll->head != NULL) // just move the remainder of the nodes to the back linked list
    {
        insertNode(resultBackList, indexxBack++, ll->head->item);
        removeNode(ll,0);
    }
}
