...
//////////////////////////////
    ...
    while (hashNum<TABLESIZE)
    {
        ...
        //DONE checking after the match
        else if (inserted == 1 && hashTable[curSlot].indicator == EMPTY)
        {
            break;
        }

        //match. but need to go on and check the subsequent ones
        ...
        //this is one of the checks we need to do
        else if (inserted == 1 && hashTable[curSlot].indicator == DELETED)
        {
            numComparisons++;
        }

        else if (inserted == 0 && hashTable[curSlot].indicator == USED)
        {
            numComparisons++;
        }

        else if (inserted == 1 && hashTable[curSlot].indicator == USED)
        {
            //printf("%d %d\n", hashTable[curSlot].key, numComparisons);
            numComparisons++;
        }
