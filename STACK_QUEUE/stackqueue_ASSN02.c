...
//////////////////////////////
    ...
    //push all integers from linked list to stack
...
//////////// TODO ////////////
//////////////////////////////
    //remove all even integers from the stack
    // 2 1 3 4 5 1
    // ^rm
    // 1 3 4 5 1
    // ^move
    ...
    {
        itemm = pop(s);
        if (itemm % 2 == 0) //the integer is even; don't care
        {
            continue;
        }
        else //the integer is odd; save it
        {
            push(&tempStack, itemm);
        }
    }
