...
//////////////////////////////
    ...
    //enqueue all integers from linked list to queue
...
//////////// TODO ////////////
//////////////////////////////
    //remove all odd integers from the queue
    // 1 2 3 4 5 1
    // ^rm
    // 2 3 4 5 1
    // ^move
    ...
    {
        itemm = dequeue(q);
        if (itemm % 2 == 0) //the integer is even; save it
        {
            enqueue(&tempQueue, itemm);
        }
        else //the integer is odd; don't care
        {
            continue;
        }
    }
